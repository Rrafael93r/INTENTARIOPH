    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-sm">
            <div className="mb-4 pb-4 border-b border-gray-100">
                <h3 className="text-lg font-semibold text-gray-800 m-0">Registro de Nueva Impresora</h3>
                <p className="text-sm text-gray-500 m-0 mt-1">Complete los datos para ingresar una nueva impresora al inventario</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="Ej. LaserJet Pro MFP M428fdw"
                        />
                    </div>
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    >
                        <i className="bi bi-floppy mr-2" /> Guardar Impresora
                    </button>
                </div>
            </form>
        </div>
