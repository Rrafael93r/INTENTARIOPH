...
import { createTeclado } from '../../servicios/tecladosService';
...
const FormularioCrearTeclado = ({ handleClose }: { handleClose: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await createTeclado(dataToSend);

            Swal.fire({
                icon: 'success',
                title: 'Teclado Creado',
                text: 'El teclado fue creado correctamente.',
            });
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo crear el teclado.',
            });
        }
    };
...
export default FormularioCrearTeclado;
