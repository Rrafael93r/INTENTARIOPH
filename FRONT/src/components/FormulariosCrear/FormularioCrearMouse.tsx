...
import { createMouse } from '../../servicios/mousesService';
...
const FormularioCrearMouse = ({ handleClose }: { handleClose: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await createMouse(dataToSend);

            Swal.fire({
                icon: 'success',
                title: 'Mouse Creado',
                text: 'El mouse fue creado correctamente.',
            });
            ...
            console.error("Error al crear el mouse:", error);
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo crear el mouse.',
            });
        }
    };
...
export default FormularioCrearMouse;
