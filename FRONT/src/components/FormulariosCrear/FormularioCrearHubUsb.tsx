...
import { createHubUsb } from '../../servicios/hubUsbService';
...
const FormularioCrearHubUsb = ({ handleClose }: { handleClose: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await createHubUsb(dataToSend);

            Swal.fire({
                icon: 'success',
                title: 'Hub USB Creado',
                text: 'El hub usb fue creado correctamente.',
            });
            ...
            console.error("Error al crear el hub usb:", error);
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo crear el hub usb.',
            });
        }
    };
...
export default FormularioCrearHubUsb;
