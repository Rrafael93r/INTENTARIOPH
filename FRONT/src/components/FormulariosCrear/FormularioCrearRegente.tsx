...
import { createRegente } from '../../servicios/regenteService';
...
const FormularioCrearRegente = ({ handleClose }: { handleClose: () => void }) => {
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            try {
                const farmaciasData = await getFarmacias();
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await createRegente(dataToSend);

            Swal.fire({
                icon: 'success',
                title: 'Regente Creado',
                text: 'El regente fue creado correctamente.',
            });
            ...
            console.error("Error al crear el regente:", error);
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo crear el regente.',
            });
        }
    };
...
export default FormularioCrearRegente;
