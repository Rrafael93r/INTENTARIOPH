...
const FormularioCrearPortatil = ({ handleClose }: { handleClose: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Portatil Creado',
                text: 'El portatil fue creado correctamente.',
            });
            ...
            console.error("Error al crear el portatil:", error);
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo crear el portatil.',
            });
        }
    };
...
export default FormularioCrearPortatil;
