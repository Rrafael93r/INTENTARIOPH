...
interface FormularioEditarImpresoraPosProps {
    id: number;
    handleClose: () => void;
    onSuccess: () => void;
}

const FormularioEditarImpresoraPos: React.FC<FormularioEditarImpresoraPosProps> = ({ id, handleClose, onSuccess }) => {
        ...
        const cargarDatos = async () => {
            try {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Error al cargar los datos de la impresora POS',
                });
            }
        };
        if (id) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await updateImpresoraPos(id, dataToSend);

            Swal.fire({
                icon: 'success',
                title: 'Impresora POS Actualizada',
                text: 'La impresora POS fue actualizada correctamente.',
            });
            ...
            console.error("Error al actualizar la impresora POS:", error);
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo actualizar la impresora POS.',
            });
        }
    };
...
export default FormularioEditarImpresoraPos;
