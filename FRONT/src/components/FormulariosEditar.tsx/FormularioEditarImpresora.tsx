    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-sm">
            <div className="mb-4 pb-4 border-b border-gray-100 flex justify-between items-center">
                <div>
                    <h3 className="text-lg font-semibold text-gray-800 m-0">Información de la Impresora</h3>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    >
                        <i className="bi bi-floppy mr-2" /> Actualizar Impresora
                    </button>
                </div>
            </form>
        </div>
