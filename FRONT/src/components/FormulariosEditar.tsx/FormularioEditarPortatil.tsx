...
const FormularioEditarPortatil: React.FC<FormularioEditarPortatilProps> = ({ id, handleClose, onSuccess }) => {
        ...
        const cargarDatos = async () => {
            try {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Error al cargar los datos del portatil',
                });
            }
        };
        if (id) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Portatil Actualizado',
                text: 'El portatil fue actualizado correctamente.',
            });
            ...
            console.error("Error al actualizar el portatil:", error);
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'No se pudo actualizar el portatil.',
            });
        }
    };
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4" onSubmit={handleSubmit}>
                ...
                <div className="md:col-span-2 space-y-1">
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        placeholder="Detalles adicionales sobre el portátil..."
                    ></textarea>
                </div>
...
export default FormularioEditarPortatil;
