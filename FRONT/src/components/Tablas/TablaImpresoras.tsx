            ...
            <div className="p-5 border-b border-gray-100 bg-white">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1 mb-0">Gestión de impresoras disponibles</p>
                    </div>
                ...
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p className="text-sm text-gray-700 m-0">
                            Mostrando <span className="font-medium">{currentImpresoras.length}</span> de <span className="font-medium">{filteredImpresoras.length}</span> impresoras
                        </p>
                    </div>
                    <div>
