...
import { getCiudades, deleteCiudad } from '../../servicios/ciudadesService';
import FormularioCrearCiudad from '../FormulariosCrear/FormularioCrearCiudad';
import FormularioEditarCiudad from '../FormulariosEditar.tsx/FormularioEditarCiudad';

const TablaCiudades: React.FC = () => {
    ...
    const handleDelete = async (id: number) => {
        try {
            const result = await Swal.fire({
                title: '¿Estás seguro?',
                text: "La ciudad será eliminada permanentemente.",
                icon: 'warning',
    ...
    return (
        <>
                        ...
                        <div className="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                            <div className="bg-white px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                                <h3 className="text-lg leading-6 font-semibold text-gray-800 flex items-center">
                                    <i className="bi bi-buildings-fill mr-2 text-orange-500"></i> Nueva Ciudad
                                </h3>
                            ...
                            <div className="px-6 py-5 sm:p-6 bg-gray-50">
                                <FormularioCrearCiudad handleClose={() => { handleClose(); loadItems(); }} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 text-gray-800 gap-4">
                <div>
                    <h1 className="text-2xl font-bold m-0 text-gray-900">Ciudades</h1>
                    <nav className="text-sm text-gray-500 mt-1">
                        <ol className="list-none p-0 inline-flex">
                            <li className="flex items-center">Administración <span className="mx-2 text-gray-300">/</span></li>
                            <li className="font-medium text-gray-700">Ciudades</li>
                        </ol>
                    </nav>
                </div>
                <div className="flex gap-3 w-full sm:w-auto">
                    ...
                    >
                        <i className="bi bi-plus-circle-fill mr-2"></i> Agregar Ciudad
                    </button>
                </div>
            </div>
                        ...
                        <thead className="bg-gray-50 sticky top-0 z-10">
                            <tr>
                                ...
                                <th className="p-3 text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200 align-top min-w-[250px]">
                                    ...
                                    />
                                    <div className="flex items-center">NOMBRE CIUDAD</div>
                                </th>
                                <th className="p-3 text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200 align-top min-w-[250px]">
                                    <input
                                        type="text"
                                        className="w-full px-2 py-1.5 mb-2 text-sm border border-gray-300 rounded focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 font-normal normal-case bg-white"
                                        placeholder="Filtrar Depto"
                ...
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p className="text-sm text-gray-700 m-0">
                            Mostrando <span className="font-medium">{currentItems.length}</span> de <span className="font-medium">{filteredItems.length}</span> ciudades
                        </p>
                    </div>
                    <div>
                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:p-0">
                        ...
                        <div className="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                            <div className="bg-white px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                                <h3 className="text-lg leading-6 font-semibold text-gray-800 flex items-center">
                                    <i className="bi bi-pencil-square mr-2 text-orange-500"></i> Editar Ciudad
                                </h3>
