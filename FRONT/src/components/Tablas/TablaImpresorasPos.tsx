        ...
        <>
            <Modal show={showModal} onHide={handleClose} centered size="lg">
                <Modal.Header closeButton>
                    <Modal.Title>Nueva Impresora POS</Modal.Title>
                </Modal.Header>
                <Modal.Body>
            ...
            <div className="d-flex align-items-center" style={{ color: 'black' }}>
                ...
                <div className="ms-auto">
                    <Button
                        ...
                        <i className="bi bi-plus-circle-fill me-2"></i> Agregar Impresora POS
                    </Button>
                </div>
            </div>
            ...
            <Modal show={showModal2} onHide={handleClose2} centered size="lg">
                <Modal.Header closeButton>
                    <Modal.Title>Editar Impresora POS</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {selectedId && (
