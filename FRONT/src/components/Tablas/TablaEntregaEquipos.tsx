                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h2 className="text-xl font-bold text-gray-800 m-0 flex items-center gap-2">
                            <i className="bi bi-file-earmark-text text-brand-500"></i>
                        ...
                        {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                            ...
                            return (
                                <button key={page} onClick={() => setCurrentPage(page)}
                                    className={`px-3 py-1 border rounded-lg text-sm ${currentPage === page ? "bg-brand-500 text-white border-brand-500" : "border-gray-300 hover:bg-gray-50"}`}>
                                    {page}
                                </button>
                            )
                        })}
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
                        <div className="p-6">
                            <h5 className="text-lg font-bold text-gray-800 mb-5 flex items-center gap-2">
                                <i className="bi bi-file-earmark-plus text-brand-500"></i>
