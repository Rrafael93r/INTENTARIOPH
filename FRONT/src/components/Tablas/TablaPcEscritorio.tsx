        ...
        <>
            <Modal show={showModal} onHide={handleClose} centered size="lg">
                <Modal.Header closeButton>
                    <Modal.Title>Nuevo PC de Escritorio</Modal.Title>
                </Modal.Header>
                <Modal.Body>
            ...
            <div className="d-flex align-items-center" style={{ color: 'black' }}>
                <div className="pagetitle">
                    <h1>Computadores de Escritorio</h1>
                    <nav>
                ...
                <div className="ms-auto">
                    <Button
                        ...
                        <i className="bi bi-plus-circle-fill me-2"></i> Agregar Equipo
                    </Button>
                </div>
            </div>
                    ...
                    <table className="table table-hover">
                        ...
                        <tbody>
                            {currentPcEscritorios.map((pc) => (
                                <tr key={pc.id}>
                                    <td>{pc.id}</td>
                                    <td>{typeof pc.marca === 'object' && pc.marca !== null ? pc.marca.nombre : pc.marca}</td>
                                    <td>{pc.modelo}</td>
                                    <td>{pc.serial}</td>
                                    <td>
                                        <Badge bg={pc.estado?.nombre === 'ACTIVO' ? 'success' : 'secondary'} className="rounded-pill">
                                            {pc.estado?.nombre || 'Sin Estado'}
                                        </Badge>
                                    </td>
                                    <td>{pc.funcionarios ? `${pc.funcionarios.nombre} ${pc.funcionarios.apellido}` : 'Sin asignar'}</td>
                                    <td>
            ...
            <Modal show={showModal2} onHide={handleClose2} centered size="lg">
                <Modal.Header closeButton>
                    <Modal.Title>Editar PC de Escritorio</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {selectedPcId && (
